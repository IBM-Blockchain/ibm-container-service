...
if [ "$(kubectl get pvc | grep shared-pvc | wc -l | awk '{print $1}')" == "0" ] || [ "$(kubectl get pvc | grep composer-pvc | wc -l | awk '{print $1}')" == "0" ] || [ "$(kubectl get pvc | grep ledger-pvc | wc -l | awk '{print $1}')" == "0" ]; then
